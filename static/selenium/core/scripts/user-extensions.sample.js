...
// A repeat loop to add 20 items to the Reyooz application
Selenium.prototype.addTwentyItemsToReyooz = function() {
    // Set the string without the item number that will come from the loop
    var title = "Item number ";
    var description = "Description for item, lorem ipsum dolor sit amet consectateur adispicing elit";
